...
function App() {
  ...
  const handleUsersSearch = async () => {
    ...
    // https://docs.github.com/pt/rest/search/search?apiVersion=2022-11-28#search-users
  ...
  return (
    <main>
      <section className="search">
        ...
        />
        <button onClick={handleUsersSearch} disabled={isLoadingUsers}>
          {isLoadingUsers ? "Pesquisando..." : "Pesquisar"}
        </button>
